...
<script>
  export default {
    ...
    methods: {
      changeBtn() {
        this.axios.post(process.env.VUE_APP_BASE_URL + "/reception/updateUser", this.change)
          .then(res => {
            console.log(res);
      ...
      queryBtn() {
        this.axios.post(process.env.VUE_APP_BASE_URL + "/reception/getUserById?userId=" + this.change.id)
          .then(res => {
