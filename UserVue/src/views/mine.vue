    ...
    <el-container class="wrapper">
      <el-main class="section text-left">
          ...
          <div class="text item">
            <el-row>
              <el-col :span="6" class="text-center">
                <router-link to="/history" class="text-plain order">
                  <p class="tool-text">
                    我的订单
                  </p>
                </router-link>
              ...
              <el-col :span="6" class="text-center">
                <router-link to="/checkinfo" class="text-plain info">
                  <p class="tool-text">
                    我的信息
                  </p>
                </router-link>
              ...
              <el-col :span="6" class="text-center">
                <router-link to="/changepswd" class="text-plain password">
                  <p class="tool-text">
                    密码设置
                  </p>
                </router-link>
              ...
              <el-col :span="6" class="text-center">
                <router-link to="/contact" class="text-plain contact">
                  <p class="tool-text">
                    联系我们
                  </p>
                </router-link>
        ...
        <div class="btn-logout">
          <el-button type="danger" class="btn-block" style="font-size: 18px;" @click="dialogVisible = true">
             退出登录
          </el-button>
        </div>
      </el-main>
